...
if __name__ == "__main__":
    ...
    myenv = Environment.get(workspace=azureml_workspace, name="bert_environmentp")
    env = myenv.from_pip_requirements(name="bert_environmentp", file_path='requirements/bert_requirements.txt')
