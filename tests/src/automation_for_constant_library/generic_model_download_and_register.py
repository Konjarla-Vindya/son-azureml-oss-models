...
LIST_OF_COLUMNS = ['modelId','downloads', 'lastModified','tags', 'pipeline_tag']
TASK_NAME = ['fill-mask','token-classification','question-answering','summarization','text-generation','text-classification','translation']
...
class Model:
    ...
    def get_task(self) -> str:
        ...
        models = hf_api.list_models(full=True, sort='lastModified', direction=-1)
