...
if __name__ == "__main__":
    ...
    command_job = run_azure_ml_job(code="./", command_to_run="python generic_model_download_and_register.py", environment="automate-venv:1", compute="Standard_D12", environment_variables=environment_variables)
