...
if __name__ == "__main__":
    ...
    myenv = Environment.get(workspace=azureml_workspace.from_config(), name="bert_environment")
    env = myenv.from_pip_requirements(file_path='requirements/bert_requirements.txt')
