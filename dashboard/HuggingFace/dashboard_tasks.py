...
class Dashboard():
    ...
    def workflow_last_run(self):   
     ...
     # Calculate percentages
        ...
        summary.append(f"Online Endpoint Deployment - Dynamic Installation | {total_dynamic_installation_count} | {dynamic_installation_statuses['success']} | {success_percentage:.f}% | {dynamic_installation_statuses['failure']} | {failure_percentage:.f}% | {dynamic_installation_statuses['cancelled']} | {dynamic_installation_statuses['running']} | {dynamic_installation_statuses['not_tested']}|")
        summary.append(f"Online Endpoint Deployment - Packaging | {total_packaging_count} | {packaging_statuses['success']} | {success_percentage:.f}% | {packaging_statuses['failure']} | {failure_percentage:.f}% | {packaging_statuses['cancelled']} | {packaging_statuses['running']} | {packaging_statuses['not_tested']} |")
