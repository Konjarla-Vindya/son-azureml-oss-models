...
class Dashboard():
    ...
    def get_all_workflow_names(self):
        ...
        response = requests.get(f"https://api.github.com/repos/{self.repo_full_name}/actions/workflows?per_page=300", headers=headers)
    ...
    def workflow_last_run(self):
        ...
        for workflow_name in normalized_workflows:
            try:
                workflow_runs = f"https://api.github.com/repos/{self.repo_full_name}/actions/workflows/{workflow_name}.yml/runs?per_page=300"
                ...
                if not runs["workflow_runs"]: 
                    ...
                    badgeurl = f"https://api.github.com/{self.repo_full_name}/actions/workflows/{workflow_name}.yml/badge.svg?per_page=300"
